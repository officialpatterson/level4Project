...
class EntityDimensionHandler(RequestHandler):
    ...
    def get(self, entityid, dimension):
        ...
        results = classifications.find({"entity": entityid, "dimension":dimension, "tweet.created_at":{'$gte': start, '$lt': end}}).limit(10)
        ...
        self.render("entitydimension.html", tracked=isTracked, entity=entityid, dimension=dimension, tweets=tweets, alerts = alerts, timeperiod=self.get_argument("timeperiod", 365))